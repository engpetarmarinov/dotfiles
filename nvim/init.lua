...
require("lazy").setup({
	...
	-- copilot cmp integrates copilot wiwth nvim-cmp
	{
		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					-- Show hover docs (signature/description) for the symbol under the cursor.
...
vim.keymap.set("n", "<A-S-k>", ":m .-2<CR>==", { desc = "Move current line up" })
vim.keymap.set("n", "<A-S-j>", ":m .+1<CR>==", { desc = "Move current line down" })

vim.keymap.set("v", "<A-S-k>", ":m '<-2<CR>gv=gv", { desc = "Move selection up" })
vim.keymap.set("v", "<A-S-j>", ":m '>+1<CR>gv=gv", { desc = "Move selection down" })

vim.keymap.set("i", "<A-S-k>", "<Esc>:m .-2<CR>==gi", { desc = "Move current line up" })
...
vim.keymap.set("n", "<A-S-s>", function()
	if vim.o.list then
		vim.o.list = false
	else
		vim.o.list = true
